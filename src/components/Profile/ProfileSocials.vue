...
<template>
  <div v-if="getUser?.socialLinks" class=" flex items-center gap-2">
    ...
    <div v-if="getUser?.socialLinks?.dribble" class="rounded-full border border-gray-300 p-0.5">
      <a :href="getUser?.socialLinks?.dribble" target="_blank" rel="noopener noreferrer"> <svg class="size-10"
